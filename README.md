...
[![Python](https://img.shields.io/badge/Python-3.10-blue?style=for://www.python.org/download intelligent deep learning web app that can detect Retina Diseases from retinal fundus images using a pre-trained CNN model and Grad-CAM heatmaps for visual explainability.
...
![Upload Mode](screenshots/upload_image[Prediction](screenshots/p screenshots as needed in screenshots/ folder)	
...
Model Type: CNN trained via Teachable Machine
